...
CAN_ConfigMsgType bios_cnf_can_messages[] = {
	{ 0, CNF_CAN_CH_RX, CNF_CAN_DATA_FRAME, CNF_CAN_IDE_STD, 0x345,         0xFFF,      Can_Manager_PduHandler0  },
	{ 1, CNF_CAN_CH_RX, CNF_CAN_DATA_FRAME, CNF_CAN_IDE_STD, 0x123,         0xFFF,      NULL  },
	{ 2, CNF_CAN_CH_TX, CNF_CAN_DATA_FRAME, CNF_CAN_IDE_STD, 0x17F,         0xFFF,      NULL  }
};
...
CAN_ConfigDeviceType bios_cnf_can_dev[] = {
	{
		...
		&bios_cnf_can_baudrate_options[0],              /* CAN Baud rate Configuration BR 500kbps*/
